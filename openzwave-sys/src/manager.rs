...
pub use self::{
    ...
    manager_get_suc_node_id as get_suc_node_id, manager_get_value_as_bool as get_value_as_bool,
    manager_get_value_as_byte as get_value_as_byte,
    manager_get_value_as_float as get_value_as_float, manager_get_value_as_int as get_value_as_int,
    manager_get_value_as_raw as get_value_as_raw, manager_get_value_as_short as get_value_as_short,
    manager_get_value_as_string as get_value_as_string,
    manager_get_value_float_precision as get_value_float_precision,
    manager_get_value_help as get_value_help, manager_get_value_label as get_value_label,
    ...
    manager_get_value_list_values as get_value_list_values, manager_get_value_max as get_value_max,
    manager_get_value_min as get_value_min, manager_get_value_units as get_value_units,
    manager_heal_network as heal_network, manager_heal_network_node as heal_network_node,
    manager_is_bridge_controller as is_bridge_controller, manager_is_polled as is_polled,
    manager_is_primary_controller as is_primary_controller,
    manager_is_value_polled as is_value_polled, manager_is_value_read_only as is_value_read_only,
    manager_is_value_set as is_value_set, manager_is_value_write_only as is_value_write_only,
    ...
    manager_node_get_generic as get_node_generic, manager_node_get_location as get_node_location,
    ...
    manager_node_get_name as get_node_name, manager_node_get_neighbors as get_node_neighbors,
    ...
    manager_node_get_query_stage as get_node_query_stage, manager_node_get_role as get_node_role,
    manager_node_get_role_string as get_node_role_string,
    manager_node_get_security as get_node_security, manager_node_get_specific as get_node_specific,
    manager_node_get_type as get_node_type, manager_node_get_version as get_node_version,
...
extern "C" {
    ...
    pub fn manager_add_watcher(
        manager: *mut Manager,
        cb: extern "C" fn(notification: *const Notification, ctx: *const c_void),
        ctx: *const c_void,
    ) -> bool;
    pub fn manager_remove_watcher(
        manager: *mut Manager,
        cb: extern "C" fn(notification: *const Notification, ctx: *const c_void),
        ctx: *const c_void,
    ) -> bool;
    pub fn manager_add_driver(
        manager: *mut Manager,
        device: *const c_char,
        interface: *const ControllerInterface,
    ) -> bool;
    pub fn manager_remove_driver(manager: *mut Manager, device: *const c_char) -> bool;
    pub fn manager_get_controller_node_id(manager: *mut Manager, home_id: u32) -> u8;
    ...
    pub fn manager_get_controller_interface_type(
        manager: *mut Manager,
        home_id: u32,
    ) -> ControllerInterface;
    pub fn manager_get_library_version(
        manager: *mut Manager,
        home_id: u32,
        rust_string_creator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_get_library_type_name(
        manager: *mut Manager,
        home_id: u32,
        rust_string_creator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_get_controller_path(
        manager: *mut Manager,
        home_id: u32,
        rust_string_creator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_get_poll_interval(manager: *mut Manager) -> i32;
    pub fn manager_set_poll_interval(
        manager: *mut Manager,
        interval_ms: i32,
        is_between_each_poll: bool,
    );
    pub fn manager_enable_poll_with_intensity(
        manager: *mut Manager,
        value: *const ValueID,
        intensity: u8,
    ) -> bool;
    ...
    pub fn manager_get_value_as_bool(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut bool,
    ) -> bool;
    pub fn manager_get_value_as_byte(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut u8,
    ) -> bool;
    pub fn manager_get_value_as_float(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut c_float,
    ) -> bool;
    pub fn manager_get_value_float_precision(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut u8,
    ) -> bool;
    pub fn manager_get_value_as_int(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut i32,
    ) -> bool;
    pub fn manager_get_value_as_short(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut i16,
    ) -> bool;
    pub fn manager_get_value_as_string(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut *mut c_char,
        stringCreator: RustStringCreator,
    ) -> bool;
    pub fn manager_get_value_as_raw(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut *mut c_void,
        vecCreator: RustVecCreator<u8>,
    ) -> bool;
    pub fn manager_get_value_list_selection_as_string(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut *mut c_char,
        stringCreator: RustStringCreator,
    ) -> bool;
    pub fn manager_get_value_list_selection_as_int(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut i32,
    ) -> bool;
    pub fn manager_get_value_list_items(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut *mut c_void,
        vecCreator: RustVecCreator<*const c_char>,
    ) -> bool;
    pub fn manager_get_value_list_values(
        manager: *mut Manager,
        id: *const ValueID,
        result: *mut *mut c_void,
        vecCreator: RustVecCreator<i32>,
    ) -> bool;
    ...
    pub fn manager_set_value_float(
        manager: *mut Manager,
        id: *const ValueID,
        value: c_float,
    ) -> bool;
    ...
    pub fn manager_set_value_string(
        manager: *mut Manager,
        id: *const ValueID,
        value: *const c_char,
    ) -> bool;
    pub fn manager_set_value_raw(
        manager: *mut Manager,
        id: *const ValueID,
        value: *const u8,
        len: u8,
    ) -> bool;
    pub fn manager_set_value_list_selection_string(
        manager: *mut Manager,
        id: *const ValueID,
        value: *const c_char,
    ) -> bool;

    pub fn manager_node_is_listening_device(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
    ) -> bool;
    pub fn manager_node_is_frequent_listening_device(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
    ) -> bool;
    pub fn manager_node_is_beaming_device(manager: *mut Manager, home_id: u32, node_id: u8)
        -> bool;
    pub fn manager_node_is_routing_device(manager: *mut Manager, home_id: u32, node_id: u8)
        -> bool;
    pub fn manager_node_is_security_device(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
    ) -> bool;
    ...
    pub fn manager_node_get_type(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_manufacturer_name(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_product_name(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_name(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_location(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_manufacturer_id(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_product_type(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_product_id(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ) -> *mut c_char;
    pub fn manager_node_get_query_stage(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ...
    pub fn manager_node_get_device_type_string(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ...
    pub fn manager_node_get_role_string(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ...
    pub fn manager_node_get_plus_type_string(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        stringCreator: RustStringCreator,
    ...
    pub fn manager_node_get_neighbors(
        manager: *mut Manager,
        home_id: u32,
        node_id: u8,
        vecCreator: RustVecCreator<u8>,
    ...
    pub fn manager_node_get_class_information(
        ...
        node_id: u8,
        command_class_id: u8,
        class_name: *mut *mut c_char,
        class_version: *mut u8,
        stringCreator: RustStringCreator,
    ) -> bool;
}
